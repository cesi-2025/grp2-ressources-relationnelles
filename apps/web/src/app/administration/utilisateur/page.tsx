...
export default function RessourcesPage() {
  ...
  const handleSave = (updated: UserItem) => {
  ...
  const handleCreate = (newUser: UserItem) => {
  ...
  return (
    <div style={{ padding: "40px 24px", minHeight: "100vh", background: "#f8fafc", fontFamily: "'Segoe UI', system-ui, sans-serif" }}>
                ...
                >
                  ...
                  <td style={{ padding: "14px 16px", whiteSpace: "nowrap" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                      <Avatar name={item.nom} id={item.id} />
                  ...
                  <td style={{ padding: "14px 16px", fontSize: 12, color: "#94a3b8", whiteSpace: "nowrap" }}>
                    {new Date(item.joined).toLocaleDateString("fr-FR")}
                  </td>
