...
export default function AdminDashboardPage() {
  ...
  }, [user, isModerator, filterP, filterC, filterRelT, filterResT]);
  ...
  return (
    <div style={s.page}>
      <div style={s.container}>
        ...
        {/* ✅ Statistiques uniquement pour admin/super_admin */}
        {isModerator ? (
          <div style={{ background: '#f0f9ff', border: '1px solid #bae6fd', borderRadius: 10, padding: '16px 20px', marginBottom: 32 }}>
            <p style={{ margin: 0, color: '#0369a1', fontSize: 14, fontFamily: "'Poppins', sans-serif" }}>
              Les statistiques sont réservées aux administrateurs. Rendez-vous dans{' '}
              <a href="/admin/moderation" style={{ fontWeight: 600, color: '#0369a1' }}>la modération</a>{' '}
              pour gérer les ressources et commentaires en attente.
            </p>
          </div>
        ) : (
          <>
